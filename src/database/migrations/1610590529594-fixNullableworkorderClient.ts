...
export class fixNullableworkorderClient1610590529594 implements MigrationInterface {
    name = 'fixNullableworkorderClient1610590529594'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `work_order` DROP FOREIGN KEY `FK_108a0a650b8da98a6a0c84d0240`");
        await queryRunner.query("DROP INDEX `FK_62579dc17352654f7eb118cd2fb` ON `work_order`");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE INDEX `FK_62579dc17352654f7eb118cd2fb` ON `work_order` (`client_rut`)");
